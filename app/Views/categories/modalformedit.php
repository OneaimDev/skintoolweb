    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modaleditkategoriLabel">Edit Data Categories</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <?= form_open('categories/edit', ['class' => 'formsimpan','id'=>'frmsimpan','enctype'=>'multipart/form-data']) ?>
            <input type="hidden" name="aksi" id="aksi" value="0">
            <div class="modal-body">
                <input type="hidden" name="id" id="id" value = "<?=$categories['id']?>">
                <div class="form-group">
                    <label for="namakategori">Nama Categories</label>
                    <input type="text" name="namakategori" id="namakategori" class="form-control form-control-sm" value = "<?=$categories['categories_name']?>" required>
                </div>
                <div class="form-group">
