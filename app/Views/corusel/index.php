                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="hapusKat('<?= $row['id'] ?>')">
...
<script>
    function hapusKat(id) {
        Swal.fire({
            ...
            html: "Kategori dengan ID <strong>" + id + "</strong> akan dihapus!",
            icon: 'warning',
